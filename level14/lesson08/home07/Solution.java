...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        {
            if (a instanceof Apt1Room) ((Apt1Room) a).clean1Room();//написать тут вашу реализацию пунктов 1-4
            if (a instanceof Apt2Room) ((Apt2Room) a).clean2Rooms();//написать тут вашу реализацию пунктов 1-4
            if (a instanceof Apt3Room) ((Apt3Room) a).clean3Rooms();//написать тут вашу реализацию пунктов 1-4
        }
    }
